...
<template>
	<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
		<g fill="none">
			...
			<path fill="url(#tokenBrandedChat1)" d="M7.625 12a1.25 1.25 0 1 0 0-2.5a1.25 1.25 0 0 0 0 2.5" />
			<path fill="url(#tokenBrandedChat2)" d="M11.687 12a1.25 1.25 0 1 0 0-2.5a1.25 1.25 0 0 0 0 2.5" />
			<path fill="url(#tokenBrandedChat3)" d="M15.75 12.001a1.25 1.25 0 1 0 0-2.5a1.25 1.25 0 0 0 0 2.5" />
			<defs>
				<linearGradient id="tokenBrandedChat0" x1="12" x2="12" y1="2.625" y2="21.375" gradientUnits="userSpaceOnUse">
					<stop stop-color="#1bc9fa" />
					<stop offset="1" stop-color="#1778f0" />
				</linearGradient>
				<linearGradient id="tokenBrandedChat1" x1="12" x2="12" y1="2.625" y2="21.375" gradientUnits="userSpaceOnUse">
					<stop stop-color="#1bc9fa" />
					<stop offset="1" stop-color="#1778f0" />
				</linearGradient>
				<linearGradient id="tokenBrandedChat2" x1="12" x2="12" y1="2.625" y2="21.375" gradientUnits="userSpaceOnUse">
					<stop stop-color="#1bc9fa" />
					<stop offset="1" stop-color="#1778f0" />
				</linearGradient>
				<linearGradient id="tokenBrandedChat3" x1="12" x2="12" y1="2.625" y2="21.375" gradientUnits="userSpaceOnUse">
					<stop stop-color="#1bc9fa" />
					<stop offset="1" stop-color="#1778f0" />
				</linearGradient>
			</defs>
